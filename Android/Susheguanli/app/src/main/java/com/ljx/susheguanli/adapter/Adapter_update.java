...
public class Adapter_update extends BaseAdapter {
    Context context;
    List<DormitoryBean> mData;
    LayoutInflater inflater;
    public Adapter_update(Context context, List<DormitoryBean> mData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_dormitory_update, parent, false);
        ...
        holder.TvMuch.setText("人数:"+bean.getMuch());
        holder.TvSex.setText("类别:"+bean.getSex());
