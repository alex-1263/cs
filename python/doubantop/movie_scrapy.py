...
# 拼接
movie_data = pd.concat([name_pd,year_pd,rate_pd,director_pd,genre_pd,country_pd,language_pd,length_pd],axis=1)
movie_data.columns=['电影','年份','评分','导演','类型','国家/地区','语言','时长']
#保留电影中文名
...
movie_data.head()
# 输出
outputpath='./dbmovies.txt' ##这里需要改路径名
