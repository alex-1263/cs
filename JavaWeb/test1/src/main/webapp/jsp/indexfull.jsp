    ...
    <div id="content">
        <div id="adv">
            ...
            <TABLE cellSpacing=0 cellPadding=0 width=575 align=center>
                <TBODY>
                <TR>
                    <TD id=IDS_DIV_MAIN_TOP_ROLL_DETAIL width=500 height=235><IMG class=clssMainRoll height=235 src="../css/images/shower_01.jpg" width=500 border=0 name=IMG_MAIN_TOP_ROLL_DETAIL></TD>
                    <!--
                    ...
                    <TD width=283 bgcolor="#F4F4F4"><TABLE cellSpacing=0 cellPadding=0 align=center>
                        ...
                        <TR>
                            <TD align=right height=60><IMG style="DISPLAY: none"	height=5 src="" width=9 align=absMiddle border=0 name=IMGS_MAIN_TOP_ROLL_THUMBNAIL><IMG
                                    style="CURSOR: pointer" onclick=MainTopRoll.alterImage(0) src="../css/images/mini_01.jpg" border=0></TD>
                        </TR>
                        <TR>
                            <TD align=right height=60><IMG style="DISPLAY: none" 	height=5 src="" width=9 align=absMiddle border=0 name=IMGS_MAIN_TOP_ROLL_THUMBNAIL><IMG
                                    style="CURSOR: pointer" onclick=MainTopRoll.alterImage(1) src="../css/images/mini_02.jpg" border=0></TD>
                        </TR>
                        <TR>
                            <TD align=right height=60><IMG style="DISPLAY: none"  height=5 src="" width=9 align=absMiddle border=0 name=IMGS_MAIN_TOP_ROLL_THUMBNAIL><IMG
                                    style="CURSOR: pointer" onclick=MainTopRoll.alterImage(2) src="../css/images/mini_03.jpg" border=0></TD>
                        </TR>
                        <TR>
                            <TD align=right height=60><IMG style="DISPLAY: none" height=5 src="" width=9 align=absMiddle border=0 name=IMGS_MAIN_TOP_ROLL_THUMBNAIL><IMG
                                    style="CURSOR: pointer" onclick=MainTopRoll.alterImage(3) src="../css/images/mini_04.jpg" border=0></TD>
                        </TR>
                        </TBODY>
                    </TABLE></TD>
                </TR>
