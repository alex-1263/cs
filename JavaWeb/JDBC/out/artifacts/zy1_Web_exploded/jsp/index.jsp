...
<div id="header">
    <div id="header_inside">
        <p><img src="../css/images/header1.jpg" alt="" usemap="#Map"/>
        </p>
        <div id="menu">
            <ul>
    ...
    <div id="right">
        <div id="login">
            ...
            <form id="loginform" name="loginform" method="post" action="doLogin.jsp">
                ...
                <div><strong>密　码：</strong><input name="password" type="password" id="txtPassword" size="15" value=""/>
                </div>
    ...
    <div id="content">
        <div id="adv">
            <SCRIPT language=javascript>
                ...
                MainTopRoll.addItem("", "css/images/shower_01.jpg");
                MainTopRoll.addItem("", "css/images/shower_02.jpg");
                MainTopRoll.addItem("", "css/images/shower_03.jpg");
                MainTopRoll.addItem("", "css/images/shower_04.jpg");
            </SCRIPT>
            <TABLE cellSpacing=0 cellPadding=0 width=575 align=center>
                <TBODY>
                <TR>
                    <TD id=IDS_DIV_MAIN_TOP_ROLL_DETAIL width=500 height=235><IMG class=clssMainRoll height=235
                                                                                  src="../css/images/shower_01.jpg"
                                                                                  width=500 border=0
                                                                                  name=IMG_MAIN_TOP_ROLL_DETAIL></TD>
                    <!--
                    <TD width=283 bgcolor="#F4F4F4" style="DISPLAY: none">
                    -->
                    <TD width=283 bgcolor="#F4F4F4">
                        <TABLE cellSpacing=0 cellPadding=0 align=center>
                            <TBODY>
                            <TR>
                                <TD align=right height=60><IMG style="DISPLAY: none" height=5 src="" width=9
                                                               align=absMiddle border=0
                                                               name=IMGS_MAIN_TOP_ROLL_THUMBNAIL><IMG
                                        style="CURSOR: pointer" onclick=MainTopRoll.alterImage(0)
                                        src="../css/images/mini_01.jpg" border=0></TD>
                            </TR>
                            <TR>
                                <TD align=right height=60><IMG style="DISPLAY: none" height=5 src="" width=9
                                                               align=absMiddle border=0
                                        ...
                                        src="../css/images/mini_02.jpg" border=0></TD>
                            </TR>
                            <TR>
                                <TD align=right height=60><IMG style="DISPLAY: none" height=5 src="" width=9
                                                               align=absMiddle border=0
                                        ...
                                        src="../css/images/mini_03.jpg" border=0></TD>
                            </TR>
                            <TR>
                                <TD align=right height=60><IMG style="DISPLAY: none" height=5 src="" width=9
                                                               align=absMiddle border=0
                                        ...
                                        src="../css/images/mini_04.jpg" border=0></TD>
                            </TR>
                            </TBODY>
                        </TABLE>
                    </TD>
        ...
        <div id="advlist">
            <div>
                ...
                <p><a href="#"><img src="../css/images/iphone12.jpg" alt="" width="75" height="50"></a></p>
            ...
            <div>
                ...
                <p><a href="#"><img src="../css/images/canoneos5d_small.jpg" alt="" width="75" height="50"></a></p>
            ...
            <div>
                ...
                <p><a href="#"><img src="../css/images/ipad_small.jpg" alt="" width="75" height="50"></a></p>
