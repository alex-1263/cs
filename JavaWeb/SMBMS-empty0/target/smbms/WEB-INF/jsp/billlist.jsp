...
<div class="right">
    ...
    <div class="search">
        <form method="get" action="${pageContext.request.contextPath }/queryBill">
            ...
            <a href="${pageContext.request.contextPath }/billAddPage">添加订单</a>
        </form>
    </div>
    <!--账单表格 样式和供应商公用-->
    <table class="providerTable" cellpadding="0" cellspacing="0">
        ...
        <c:forEach var="bill" items="${billList }" varStatus="status">
            <tr>
                ...
                <td>
                    <span><a class="viewBill" billid="${bill.id} " href="javascript:;" billcc="${bill.billCode }"><img
                            src="${pageContext.request.contextPath }/images/read.png" alt="查看" title="查看"/></a></span>
                    <span><a class="modifyBill" billid="${bill.id}" href="javascript:;" billcc="${bill.billCode }"><img
                            src="${pageContext.request.contextPath }/images/xiugai.png" alt="修改" title="修改"/></a></span>
                    <span><a class="deleteBill" billid="${bill.id}" href="javascript:;" billcc="${bill.billCode }"><img
