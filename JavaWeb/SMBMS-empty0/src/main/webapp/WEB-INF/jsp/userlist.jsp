...
<div class="right">
    ...
    <div class="search">
        <form method="get" action="${pageContext.request.contextPath }/queryUser">
            <span>用户名：</span>
            ...
            <a href="${pageContext.request.contextPath}/useraddPage">添加用户</a>
        </form>
    </div>
    <!--用户-->
            ...
            <tr>
                ...
                <td>
                    ...
                    <span><a class="deleteUser" href="javascript:;" userid="${user.id }"
                             username="${user.userName }"><img src="${pageContext.request.contextPath }/images/schu.png"
